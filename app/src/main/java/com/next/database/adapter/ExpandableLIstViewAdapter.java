package com.next.database.adapter;
...
public class ExpandableLIstViewAdapter extends BaseExpandableListAdapter
{
    ...
    public void setHashMap(HashMap<Integer, List<Employee>> hashmap)
    {
        selectdMap.putAll(hashmap);
    }
    ...
    public int getChildrenCount(int groupPosition)
    {
       ...
       int deptId = deptList.get(groupPosition).getDepartmentId();
        ...
        return selectdMap.get(groupPosition).size();
    }
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent)
    {
        ...
        int id = deptList.get(groupPosition).getDepartmentId();
        total_number.setText(deptList.get(groupPosition).getGroupCount());
        return convertView;
    }
